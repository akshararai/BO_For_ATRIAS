...
model_char = 'original'; %model in which optimization are run
dog_model_char = 'original'; %model from which kernel 
...
opt.hwadjust_signal_threshold = 50; % choose a threshold of function value variance to start optimizing hyperparameters
...
dog_scores(dog_scores < -10) = -10; %saturate dog scores from sim errors
if hwadjust >= 1
...
%gpml covWarp takes a standard kernel, transform function, transform
%derivative, and final kernel dimensions as input
